  ...
  return (
    <section id="about" className="py-20 px-4 bg-gradient-to-b from-indigo-900 via-purple-800 to-blue-900 text-white">
      <div className="mb-16 text-center">
        ...
        Results-driven Full Stack Developer with 8 months of experience in building and optimizing web applications using the 
MERN stack. Adept at performance optimization, API development, and scalable application architecture. Experienced in 
Git for version control, leading to efficient code collaboration. Spearheaded React performance improvements, reducing 
load times by 30%. Passionate about solving complex technical challenges and delivering impactful solutions. 
        </p>
      </div>
